...
.controller('uploadCtrl', ['$scope', 'uploadService', '$timeout', 'varsFactoryService', 'users', '$ionicLoading', 'validarNavegacionService', 'dataTableStorageFactory',
    function ($scope, uploadService, $timeout, varsFactoryService, users, $ionicLoading, validarNavegacionService, dataTableStorageFactory) {
